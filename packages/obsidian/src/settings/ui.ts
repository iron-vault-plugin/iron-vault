...
export class IronVaultSettingTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        "When enabled, all mechanics (moves, oracles, progress tracks, clocks, meters, entities, dice rolls, and OOC comments) are inserted as inline text instead of code blocks.",
      )
      .addToggle((toggle) =>
        toggle
